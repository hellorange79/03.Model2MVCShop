...
<body bgcolor="#ffffff" text="#000000">
	...
	<form name="detailForm" action="/getProduct.do?menu=${param.menu}" method="post" enctype="multipart/form-data">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				<td width="1" class="ct_write">상품번호 <img src="/images/ct_icon_red.gif" width="3" height="3"
					align="absmiddle" />
				</td>
